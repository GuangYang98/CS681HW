...
public class CurrencyExchange {
    ...
    public static void main(String args[]) {
        ...
        CurrencyExchange maxRate = list.stream()
                .parallel()
                .max(Comparator.comparing(CurrencyExchange::getRate))
                .get();
        System.out.println("The max rate is " + maxRate);

        ArrayList<CurrencyExchange> sortedByPerRate = list.stream()
                .parallel()
                .sorted(Comparator.comparing(CurrencyExchange::getRate))
